@extends('master')
@section('content')
    <div class="container paddding" style="height: 80h">
    @auth
    @if(session('success'))
    ...
    <div class="row mx-0">
        <div class="col-4">
            ...
            <img src="{{asset('/uploads/profile/' .$profile->photo_profile)}}" class="rounded-circle" alt="CinqueTerre" width="304" height="236">
            <ul class="my-5">
